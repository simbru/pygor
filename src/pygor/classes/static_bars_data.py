...
import pygor.timeseries.methods
...
class StaticBars(Core):
    ...
    def get_AB_deltas(self, roi = None):
        return pygor.timeseries.methods.calculate_AB_deltas(self, roi = roi, a_b_ratio=self.parameters["a_b_ratio"], ignore_percentage=self.parameters["ignore_percentage"])
