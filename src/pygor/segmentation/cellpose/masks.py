"""
Mask format conversion for Cellpose I/O.
...
def to_pygor(cellpose_mask):
    """Convert Cellpose mask to pygor format.
...
def from_pygor(pygor_mask):
    """Convert pygor mask to Cellpose format.
...
def from_pygor_relabeled(pygor_mask):
    """Convert pygor mask to Cellpose format with sequential relabeling.
