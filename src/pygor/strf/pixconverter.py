...
screen_width_height_visang = (screen_vis_ang, screen_vis_ang * (screen_height_pix_au/screen_width_pix_au))
...
def pix_to_visang(*pix_nums, block_size, jitter_upsale = 4, screen_width_pix = 1820, screen_width_visang = 86.306):
