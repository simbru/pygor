def create_strf_frame(directory):
    ...
    with h5py.File(dummy_load) as opened_dummy: # dummy-load a single file to create structure of DF 
        ...
        print(dummy_load_content)
    

def legacy_create_frames(directory, *dispersion_args):
    ...
    ## To REC DFs
    Xs_, Ys_, Zs_ = get_objective_XYZ(rec_df["wParamsNum"])
